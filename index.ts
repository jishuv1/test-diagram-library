...
// tslint:disable-next-line:max-func-body-length
    ...
    let connectorSymbols: NodeModel[] = [
        ...
        { id: 'or', shape: { type: 'Basic', shape: 'Ellipse' }, offsetX: 100,
            offsetY: 100,
            width: 60,
            height: 60, },
        {
        ...
        { id: 'or2', shape: { type: 'Flow', shape: 'Extract' }, offsetX: 80,
            offsetY: 50,
            width: 60,
            height: 60, },
        {
        ...
        { id: 'or3', shape: { type: 'Basic', shape: 'Ellipse' },
    ...
    let palettes: PaletteModel[] = [
        { id: 'flow', expanded: true, symbols: flowShapes, iconCss: 'e-ddb-icons e-flow', title: 'My Libary 1' },
        { id: 'connectors', expanded: true, symbols: connectorSymbols, iconCss: 'e-ddb-icons e-connector', title: 'My Libary 2' }
    ];
